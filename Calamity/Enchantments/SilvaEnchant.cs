        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (SoulConfig.Instance.GetValue(SoulConfig.Instance.calamityToggles.SilvaMinion))
            {
                ...
                if (player.whoAmI == Main.myPlayer)
                {
                    ...
                    {
                        Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, calamity.Find<ModProjectile>("SilvaCrystal").Type, (int)(1500.0 * (double)player.GetDamage(DamageClass.Summon)), 0f, Main.myPlayer, 0f, 0f);
                    }
                }
            }
