...
召唤小熊，肯德拉和第三贤者宠物");
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (SoulConfig.Instance.GetValue(SoulConfig.Instance.calamityToggles.DaedalusMinion) && player.whoAmI == Main.myPlayer)
            {
                ...
                {
                    Projectile.NewProjectile(player.Center.X, player.Center.Y, 0f, -1f, calamity.Find<ModProjectile>("DaedalusCrystal").Type, (int)(95f * player.GetDamage(DamageClass.Summon)), 0f, Main.myPlayer, 0f, 0f);
                }
            }
